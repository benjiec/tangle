import requests
from tangle.kegg import parse_module_definition, ModuleDefinitionFormatter
...
with open(Defaults.kegg_module_list_tsv()) as f:
...
formatter.to_csv(Defaults.kegg_module_def_csv())
